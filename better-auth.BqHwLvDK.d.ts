import { L as LiteralString, d as LiteralUnion, D as DeepPartial, U as UnionToIntersection, S as StripEmptyObjects, b as Prettify, O as OmitId, P as PrettifyDeep, E as Expand } from './better-auth.Bi8FQwDD.js';
import * as zod from 'zod';
import { ZodSchema, z } from 'zod';
import { a as OAuthProvider, S as SocialProviders, b as SocialProviderList, O as OAuth2Tokens } from './better-auth.CQXg7f-2.js';
...
export { createLogger as $, init as E, levels as X, shouldPublishLog as Y, createEmailVerificationToken as a$, logger as a0, createInternalAdapter as a3, createFieldAttribute as a6, deleteSessionCookie as aA, parseCookies as aB, getSessionCookie as aD, getCookieCache as aE, parseSetCookieHeader as aF, setCookieToHeader as aG, getEndpoints as aH, router as aI, signInSocial as aJ, signInEmail as aK, callbackOAuth as aL, getSession as aM, getSessionFromCtx as aN, sessionMiddleware as aO, requestOnlySessionMiddleware as aP, freshSessionMiddleware as aQ, listSessions as aR, revokeSession as aS, revokeSessions as aT, revokeOtherSessions as aU, signOut as aV, requestPasswordReset as aW, forgetPassword as aX, requestPasswordResetCallback as aY, forgetPasswordCallback as aZ, resetPassword as a_, getAuthTables as af, accountSchema as ag, userSchema as ah, sessionSchema as ai, verificationSchema as aj, parseOutputData as ak, getAllFields as al, parseUserOutput as am, parseAccountOutput as an, parseSessionOutput as ao, parseInputData as ap, parseUserInput as aq, parseAdditionalUserInput as ar, parseAccountInput as as, parseSessionInput as at, mergeSchema as au, createCookieGetter as av, getCookies as aw, setCookieCache as ay, setSessionCookie as az, sendVerificationEmailFn as b0, sendVerificationEmail as b1, verifyEmail as b2, updateUser as b3, changePassword as b4, setPassword as b5, deleteUser as b6, deleteUserCallback as b7, changeEmail as b8, error as b9, ok as ba, signUpEmail as bb, listUserAccounts as bc, linkSocialAccount as bd, unlinkAccount as be, getAccessToken as bf, refreshToken as bg, accountInfo as bh, originCheckMiddleware as bi, originCheck as bj, BASE_ERROR_CODES as f, createAuthMiddleware as j, createAuthEndpoint as k, optionsMiddleware as o, checkPassword as s, betterAuth as u };
export type { AdapterDebugLogs as A, BetterAuthOptions as B, CreateCustomAdapter as C, Account as D, AdapterSchemaCreation as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, AdapterInstance as J, KyselyDatabaseType as K, SecondaryStorage as L, Models as M, FilteredAPI as N, FilterActions as O, InferSessionAPI as P, InferAPI as Q, RateLimit as R, Session as S, LogLevel as T, User as U, Verification as V, Where as W, Logger as Z, LogHandlerParams as _, Adapter as a, FieldAttribute as a1, FieldType as a2, InternalAdapter as a4, FieldAttributeConfig as a5, InferValueType as a7, InferFieldsOutput as a8, InferFieldsInput as a9, EligibleCookies as aC, InferFieldsInputClient as aa, PluginFieldAttribute as ab, InferFieldsFromPlugins as ac, InferFieldsFromOptions as ad, BetterAuthDbSchema as ae, BetterAuthCookies as ax, AdapterConfig as b, CustomAdapter as c, CleanedWhere as d, AdapterTestDebugLogs as e, AuthPluginSchema as g, BetterAuthPlugin as h, InferPluginErrorCodes as i, AuthEndpoint as l, AuthMiddleware as m, Auth as n, AuthContext as p, InferUser as q, InferSession as r, WithJsDoc as t, AdditionalUserFieldsInput as v, AdditionalUserFieldsOutput as w, AdditionalSessionFieldsInput as x, AdditionalSessionFieldsOutput as y, InferPluginTypes as z };
